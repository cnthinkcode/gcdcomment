...
// https://elixir.bootlin.com/linux/latest/source/include/uapi/linux/futex.h#L140

#define DLOCK_OWNER_MASK			((dispatch_lock)FUTEX_TID_MASK)
#define DLOCK_WAITERS_BIT			((dispatch_lock)FUTEX_WAITERS)  // 0x3fffffff
#define DLOCK_FAILED_TRYLOCK_BIT	((dispatch_lock)FUTEX_OWNER_DIED) // 0x40000000
